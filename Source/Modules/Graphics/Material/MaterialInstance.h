...
class MaterialInstance : public AssetReferenceableMixin
{
public:
    ...
    const CBMaterial& GetMaterialConstants() const { return m_Params.GetCB(); }
    const std::array<std::string, ParameterBlock::kMaxTextures>& GetTexturePaths() const { return m_Params.GetTexturePaths(); }
