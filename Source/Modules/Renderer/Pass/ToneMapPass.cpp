...
void ToneMapPass::Execute(Dx11Context& gfx, ID3D11ShaderResourceView* sceneColorHDR)
{
    ...
    // ToneMap is a full-screen VS+PS pass. Clear stale GS left by previous debug pass.
    ctx->GSSetShader(nullptr, nullptr, 0);
    ID3D11ShaderResourceView* nullGSsrvs[8] = { nullptr,nullptr,nullptr,nullptr,nullptr,nullptr,nullptr,nullptr };
    ctx->GSSetShaderResources(0, 8, nullGSsrvs);
