...
public:
    ...
    void RenderSelectedAssetSummary();
    void RenderAssetPathRow(const char* label, const std::string& value, bool allowCopy);
...
private:
    ...
    ContentBrowserState m_contentBrowserState;
};
